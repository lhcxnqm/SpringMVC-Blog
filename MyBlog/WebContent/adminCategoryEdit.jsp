                                        ...
                                        <div class="row">
	                                        <form action="<%=base %>admin/CategoryEdit" method="post">
	                                            ...
	                                            <div class="col-md-4"><input type="text" placeholder="分类名称" class="form-control" name="title"></div>
	                                           	<div class="col-md-2"><button title="Create new cluster" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <span class="bold">修改分类</span></button></div>  
	                                        ...
	                                        <div class="col-sm-1">
	                                        	<a href="<%=base %>admin/Category"><button class="btn btn-primary btn-sm">返回</button></a>
	                                        </div>
                                        </div>                                       	
                                    </div>
                                </div>                                
