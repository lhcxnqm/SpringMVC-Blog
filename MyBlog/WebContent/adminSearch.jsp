                        ...
                        <div class="ibox-content m-b-sm border-bottom">
                            <div class="text-center p-lg">
								<div class="form-group">
                                    <div class="col-sm-10">
                                        <div class="row">
	                                        <form action="<%=base %>admin/Search" method="post">
	                                        	<input name="page" value="<%=request.getParameter("page") %>" type="hidden">
	                                            <div class="col-md-4"><input type="text" placeholder="查询文章" class="form-control" name="title"></div>
	                                           	<div class="col-md-2"><button title="Create new cluster" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <span class="bold">查询文章</span></button></div> 
	                                           	（什么都不输入则显示所有文章） 
                       ...
                       <% List<Post> posts = (List<Post>)request.getAttribute("posts");
                        ...
                        <div class="faq-item"> 
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                	<a href="<%=base %>admin/PostEdit?page=1&action=edit&id=<%=post.getId() %>"><button type="button" class="btn btn-w-m btn-primary">编辑</button></a>                                   	 
                                </div>
                                <div class="col-md-2">
