                    ...
                    <div class="ibox">
                        <div class="ibox-content product-box">
                            ...
                            <div class="product-imitation">
                                <h2 style="font-weight:bold"><%=category.getTitle() %></h2>
                            </div>
                            <div class="product-desc">
                                <span class="product-price">
                                    <%=category.getCategory_count() %>篇
                                </span>
                                
                                <a class="product-name">总浏览：<%=category.getView_count() %>&nbsp;次</a>
                                <small class="text-muted">热门文章：《<%=category.getPopularPost() %>》</small>
                                <div class="small m-t-xs">
                                    <%=category.getTitle() %>是一门非常牛X的语言
                                </div>
