              ...
              <div class="col-lg-12">
                    <div class="wrapper wrapper-content animated fadeInRight">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
	                                        <form action="<%=base %>admin/Category" method="post">
	                                            <div class="col-md-4"><input type="text" placeholder="分类名称" class="form-control" name="title"></div>
	                                           	<div class="col-md-2"><button title="Create new cluster" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <span class="bold">添加分类</span></button></div>  
                        ...
                        <div class="faq-item">
                            <div class="row">
                                <div class="col-md-8">
                                    <a href="?id=<%=category.getId() %>" class="faq-question"><%=category.getTitle() %></a>
                                    <small><i class="fa fa-clock-o"></i><%=category.getCreated_at() %></small>
                                </div>
                                <div class="col-md-2">
                                	<a href="<%=base %>admin/CategoryEdit?action=edit&id=<%=category.getId() %>"><button type="button" class="btn btn-w-m btn-primary">编辑</button></a>                                   	 
                                </div>
                                <div class="col-md-2">
